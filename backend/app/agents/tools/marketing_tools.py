...
def build_tools(db: Session, run: AgentRun, agent_definition_id: str) -> list:
    ...
    @beta_tool
    def draft_menu_change_proposal(menu_item_id: str, change_type: str, details: str) -> str:
        ...
        action = agent_crud.create_action(
            ...
            payload={"menu_item_id": item.id, "item_name": item.name, "change_type": change_type, "details": details},
        )
